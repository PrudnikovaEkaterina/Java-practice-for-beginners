...
//Всего существует 6 различных шахматных фигур: король (англ. king), ферзь (англ. queen),
// ладья (англ. rook), слон (англ. bishop), конь (англ. knight) и пешка (англ. pawn).
...
//Пешка (черная)  ♟ Конь (черный)   ♞ Слон (черный)   ♝ Ладья (черная)  ♜ Ферзь (черный)  ♛ Король (черный) ♚
...
public class Task1 {
    public static void main(String[] args) {
       ChessPiece [] mas= {ChessPiece.PAWN_BLACK, ChessPiece.PAWN_BLACK, ChessPiece.PAWN_BLACK, ChessPiece.PAWN_BLACK,
