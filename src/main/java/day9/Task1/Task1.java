...
// Для этого поля тоже необходимо создать геттер. Конструктор в классе Студент должен принимать на вход
// два аргумента - имя и название учебной группы.
...
// Затем, вызовите printInfo() на объектах и посмотрите на результат.
    public static void main(String[] args) {
        Student student=new Student("Екатерина","555");
        Teacher teacher=new Teacher("Иван Иванович", "Автодром");
